...
$(deps_block/blk-mq.o):
#SYMVER blk_freeze_queue_start 0x77f8fd43
#SYMVER blk_mq_freeze_queue_wait 0x4e09f498
#SYMVER blk_mq_freeze_queue_wait_timeout 0xc1664f02
#SYMVER blk_mq_freeze_queue 0x14e19c1c
#SYMVER blk_mq_unfreeze_queue 0x17c018c8
#SYMVER blk_freeze_queue_start_non_owner 0xbf51a25c
#SYMVER blk_mq_unfreeze_queue_non_owner 0x0c8b9023
#SYMVER blk_mq_quiesce_queue_nowait 0x230e8d2f
#SYMVER blk_mq_wait_quiesce_done 0x3b8b56e8
#SYMVER blk_mq_quiesce_queue 0x3d15ea93
#SYMVER blk_mq_unquiesce_queue 0xbca8ddda
#SYMVER blk_mq_quiesce_tagset 0x25c86ec2
#SYMVER blk_mq_unquiesce_tagset 0xbccebe3c
#SYMVER blk_rq_init 0x51b2f719
#SYMVER blk_mq_alloc_request 0xc8d61b2c
#SYMVER blk_mq_alloc_request_hctx 0xbd812b7b
#SYMVER blk_mq_free_request 0x25e078eb
#SYMVER blk_dump_rq_flags 0x899d8aa2
#SYMVER blk_update_request 0x7a74ec7d
#SYMVER __blk_mq_end_request 0x86647e09
#SYMVER blk_mq_end_request 0xc1f29887
#SYMVER blk_mq_end_request_batch 0x2a1f047c
#SYMVER blk_mq_complete_request_remote 0x72831c3f
#SYMVER blk_mq_complete_request 0x7c308330
#SYMVER blk_mq_start_request 0xee4bc93c
#SYMVER blk_execute_rq_nowait 0x7fafaa0f
#SYMVER blk_rq_is_poll 0x9deaf88e
#SYMVER blk_execute_rq 0x7c4c1f72
#SYMVER blk_mq_requeue_request 0x0a77f772
#SYMVER blk_mq_kick_requeue_list 0xac865672
#SYMVER blk_mq_delay_kick_requeue_list 0x32dc8020
#SYMVER blk_mq_queue_inflight 0x7890cc1d
#SYMVER blk_mq_flush_busy_ctxs 0xd0f6d1de
#SYMVER blk_mq_delay_run_hw_queue 0x7a0f4322
#SYMVER blk_mq_run_hw_queue 0x8552d8f2
#SYMVER blk_mq_run_hw_queues 0x39ca5381
#SYMVER blk_mq_delay_run_hw_queues 0xabc6a296
#SYMVER blk_mq_stop_hw_queue 0xa66977dc
#SYMVER blk_mq_stop_hw_queues 0x186503b1
#SYMVER blk_mq_start_hw_queue 0xaef9ba39
#SYMVER blk_mq_start_hw_queues 0xc80d858b
#SYMVER blk_mq_start_stopped_hw_queue 0x468eb502
#SYMVER blk_mq_start_stopped_hw_queues 0x84b47df0
#SYMVER blk_insert_cloned_request 0x0c9508be
#SYMVER blk_rq_unprep_clone 0xdd1a09ea
#SYMVER blk_rq_prep_clone 0x2a211788
#SYMVER blk_steal_bios 0xfe74eda9
#SYMVER blk_mq_alloc_queue 0xfa4ebd2a
#SYMVER blk_mq_destroy_queue 0x6a47b5e3
#SYMVER __blk_mq_alloc_disk 0x2eeb9fd7
#SYMVER blk_mq_alloc_disk_for_queue 0xf49d2c20
#SYMVER blk_mq_init_allocated_queue 0x82149765
#SYMVER blk_mq_alloc_tag_set 0x7dd88a60
#SYMVER blk_mq_alloc_sq_tag_set 0x28db6e1e
#SYMVER blk_mq_free_tag_set 0x7d11f48b
#SYMVER blk_mq_update_nr_hw_queues 0x1629ab41
#SYMVER blk_rq_poll 0x74444e59
#SYMVER blk_mq_rq_cpu 0x2f146d0f
