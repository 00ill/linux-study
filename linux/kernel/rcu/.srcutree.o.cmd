...
$(deps_kernel/rcu/srcutree.o):
#SYMVER init_srcu_struct 0x5ad9853d
#SYMVER cleanup_srcu_struct 0x5dfba5b2
#SYMVER __srcu_read_lock 0xfed6b708
#SYMVER __srcu_read_unlock 0xc42978eb
#SYMVER call_srcu 0x064fcf4d
#SYMVER synchronize_srcu_expedited 0x57d1995a
#SYMVER synchronize_srcu 0x34749417
#SYMVER get_state_synchronize_srcu 0x6fae217e
#SYMVER start_poll_synchronize_srcu 0xd222e3a1
#SYMVER poll_state_synchronize_srcu 0xa3bbb80c
#SYMVER srcu_barrier 0x33c57e28
#SYMVER srcu_batches_completed 0x31a58e97
#SYMVER srcutorture_get_gp_data 0xa5f624d3
#SYMVER srcu_torture_stats_print 0xc5688fd0
