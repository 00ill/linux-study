...
__used __section("__versions") = {
	...
	{ 0x426b0a9d, "snd_ctl_rename" },
	{ 0xd35cce70, "_raw_spin_unlock_irqrestore" },
	{ 0x21b2995d, "media_remove_intf_link" },
	{ 0x90548a4e, "usb_string" },
	{ 0xb6266700, "snd_device_new" },
	{ 0x6b43a33c, "snd_pcm_period_elapsed_under_stream_lock" },
...
MODULE_INFO(srcversion, "073D8950BA81ECEEDAB6EDE");
