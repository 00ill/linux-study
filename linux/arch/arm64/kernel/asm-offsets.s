	.arch armv8-a
	.file	"asm-offsets.c"
// GNU C11 (Debian 12.2.0-14+deb12u1) version 12.2.0 (aarch64-linux-gnu)
...
.ascii "->MM_CONTEXT_ID 952 offsetof(struct mm_struct, context.id.counter)"	//
// 0 "" 2
...
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:131:   DEFINE(CPU_ELR_EL2,		offsetof(struct kvm_cpu_context, sys_regs[ELR_EL2]));
// 131 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_ELR_EL2 1728 offsetof(struct kvm_cpu_context, sys_regs[ELR_EL2])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:132:   DEFINE(CPU_RGSR_EL1,		offsetof(struct kvm_cpu_context, sys_regs[RGSR_EL1]));
// 132 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_RGSR_EL1 1568 offsetof(struct kvm_cpu_context, sys_regs[RGSR_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:133:   DEFINE(CPU_GCR_EL1,		offsetof(struct kvm_cpu_context, sys_regs[GCR_EL1]));
// 133 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_GCR_EL1 1576 offsetof(struct kvm_cpu_context, sys_regs[GCR_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:134:   DEFINE(CPU_APIAKEYLO_EL1,	offsetof(struct kvm_cpu_context, sys_regs[APIAKEYLO_EL1]));
// 134 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_APIAKEYLO_EL1 1488 offsetof(struct kvm_cpu_context, sys_regs[APIAKEYLO_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:135:   DEFINE(CPU_APIBKEYLO_EL1,	offsetof(struct kvm_cpu_context, sys_regs[APIBKEYLO_EL1]));
// 135 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_APIBKEYLO_EL1 1504 offsetof(struct kvm_cpu_context, sys_regs[APIBKEYLO_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:136:   DEFINE(CPU_APDAKEYLO_EL1,	offsetof(struct kvm_cpu_context, sys_regs[APDAKEYLO_EL1]));
// 136 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_APDAKEYLO_EL1 1520 offsetof(struct kvm_cpu_context, sys_regs[APDAKEYLO_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:137:   DEFINE(CPU_APDBKEYLO_EL1,	offsetof(struct kvm_cpu_context, sys_regs[APDBKEYLO_EL1]));
// 137 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_APDBKEYLO_EL1 1536 offsetof(struct kvm_cpu_context, sys_regs[APDBKEYLO_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:138:   DEFINE(CPU_APGAKEYLO_EL1,	offsetof(struct kvm_cpu_context, sys_regs[APGAKEYLO_EL1]));
// 138 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->CPU_APGAKEYLO_EL1 1552 offsetof(struct kvm_cpu_context, sys_regs[APGAKEYLO_EL1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:139:   DEFINE(HOST_CONTEXT_VCPU,	offsetof(struct kvm_cpu_context, __hyp_running_vcpu));
// 139 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->HOST_CONTEXT_VCPU 3088 offsetof(struct kvm_cpu_context, __hyp_running_vcpu)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:140:   DEFINE(HOST_DATA_CONTEXT,	offsetof(struct kvm_host_data, host_ctxt));
// 140 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->HOST_DATA_CONTEXT 0 offsetof(struct kvm_host_data, host_ctxt)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:141:   DEFINE(NVHE_INIT_MAIR_EL2,	offsetof(struct kvm_nvhe_init_params, mair_el2));
// 141 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_MAIR_EL2 0 offsetof(struct kvm_nvhe_init_params, mair_el2)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:142:   DEFINE(NVHE_INIT_TCR_EL2,	offsetof(struct kvm_nvhe_init_params, tcr_el2));
// 142 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_TCR_EL2 8 offsetof(struct kvm_nvhe_init_params, tcr_el2)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:143:   DEFINE(NVHE_INIT_TPIDR_EL2,	offsetof(struct kvm_nvhe_init_params, tpidr_el2));
// 143 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_TPIDR_EL2 16 offsetof(struct kvm_nvhe_init_params, tpidr_el2)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:144:   DEFINE(NVHE_INIT_STACK_HYP_VA,	offsetof(struct kvm_nvhe_init_params, stack_hyp_va));
// 144 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_STACK_HYP_VA 24 offsetof(struct kvm_nvhe_init_params, stack_hyp_va)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:145:   DEFINE(NVHE_INIT_PGD_PA,	offsetof(struct kvm_nvhe_init_params, pgd_pa));
// 145 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_PGD_PA 40 offsetof(struct kvm_nvhe_init_params, pgd_pa)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:146:   DEFINE(NVHE_INIT_HCR_EL2,	offsetof(struct kvm_nvhe_init_params, hcr_el2));
// 146 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_HCR_EL2 48 offsetof(struct kvm_nvhe_init_params, hcr_el2)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:147:   DEFINE(NVHE_INIT_VTTBR,	offsetof(struct kvm_nvhe_init_params, vttbr));
// 147 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_VTTBR 56 offsetof(struct kvm_nvhe_init_params, vttbr)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:148:   DEFINE(NVHE_INIT_VTCR,	offsetof(struct kvm_nvhe_init_params, vtcr));
// 148 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->NVHE_INIT_VTCR 64 offsetof(struct kvm_nvhe_init_params, vtcr)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:149:   DEFINE(NVHE_INIT_TMP,		offsetof(struct kvm_nvhe_init_params, tmp));
...
.ascii "->"
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:206:   DEFINE(FGRET_REGS_X0,			offsetof(struct fgraph_ret_regs, regs[0]));
// 206 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X0 0 offsetof(struct fgraph_ret_regs, regs[0])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:207:   DEFINE(FGRET_REGS_X1,			offsetof(struct fgraph_ret_regs, regs[1]));
// 207 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X1 8 offsetof(struct fgraph_ret_regs, regs[1])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:208:   DEFINE(FGRET_REGS_X2,			offsetof(struct fgraph_ret_regs, regs[2]));
// 208 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X2 16 offsetof(struct fgraph_ret_regs, regs[2])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:209:   DEFINE(FGRET_REGS_X3,			offsetof(struct fgraph_ret_regs, regs[3]));
// 209 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X3 24 offsetof(struct fgraph_ret_regs, regs[3])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:210:   DEFINE(FGRET_REGS_X4,			offsetof(struct fgraph_ret_regs, regs[4]));
// 210 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X4 32 offsetof(struct fgraph_ret_regs, regs[4])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:211:   DEFINE(FGRET_REGS_X5,			offsetof(struct fgraph_ret_regs, regs[5]));
// 211 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X5 40 offsetof(struct fgraph_ret_regs, regs[5])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:212:   DEFINE(FGRET_REGS_X6,			offsetof(struct fgraph_ret_regs, regs[6]));
// 212 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X6 48 offsetof(struct fgraph_ret_regs, regs[6])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:213:   DEFINE(FGRET_REGS_X7,			offsetof(struct fgraph_ret_regs, regs[7]));
// 213 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_X7 56 offsetof(struct fgraph_ret_regs, regs[7])"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:214:   DEFINE(FGRET_REGS_FP,			offsetof(struct fgraph_ret_regs, fp));
// 214 "arch/arm64/kernel/asm-offsets.c" 1
	
.ascii "->FGRET_REGS_FP 64 offsetof(struct fgraph_ret_regs, fp)"	//
// 0 "" 2
// arch/arm64/kernel/asm-offsets.c:215:   DEFINE(FGRET_REGS_SIZE,		sizeof(struct fgraph_ret_regs));
// 215 "arch/arm64/kernel/asm-offsets.c" 1
