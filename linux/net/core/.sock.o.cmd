...
$(deps_net/core/sock.o):
#SYMVER sk_ns_capable 0x37a1947a
#SYMVER sk_capable 0x8b96fd11
#SYMVER sk_net_capable 0xbd876261
#SYMVER sysctl_wmem_max 0xfac8865f
#SYMVER sysctl_rmem_max 0xb05fc310
#SYMVER memalloc_socks_key 0x77ecf68d
#SYMVER sk_set_memalloc 0x0435e23d
#SYMVER sk_clear_memalloc 0x6909521e
#SYMVER __sk_backlog_rcv 0xe6c00e39
#SYMVER sk_error_report 0xc1b89cb8
#SYMVER sock_get_timeout 0xedd17b31
#SYMVER sock_copy_user_timeval 0x5bdb7603
#SYMVER __sock_queue_rcv_skb 0xd1237017
#SYMVER sock_queue_rcv_skb_reason 0xe3d997df
#SYMVER __sk_receive_skb 0x114af337
#SYMVER __sk_dst_check 0x78803ffc
#SYMVER sk_dst_check 0x330aaa45
#SYMVER sock_bindtoindex 0x0f6b8e34
#SYMVER sk_mc_loop 0xfadb617e
#SYMVER sock_set_reuseaddr 0xf46166ba
#SYMVER sock_set_reuseport 0xb4eef7d0
#SYMVER sock_no_linger 0x114b7867
#SYMVER sock_set_priority 0x8a9e499f
#SYMVER sock_set_sndtimeo 0xc1a061cd
#SYMVER sock_enable_timestamps 0x4829c8f8
#SYMVER sock_set_keepalive 0x6afa0251
#SYMVER sock_set_rcvbuf 0xe8d48912
#SYMVER sock_set_mark 0x92302613
#SYMVER sockopt_lock_sock 0x89edb995
#SYMVER sockopt_release_sock 0xd4d6cca0
#SYMVER sockopt_ns_capable 0xc17a04a0
#SYMVER sockopt_capable 0x2a6a5aac
#SYMVER sock_setsockopt 0x78a1a4a9
#SYMVER sk_alloc 0x172d06fa
#SYMVER sk_net_refcnt_upgrade 0xcacaa747
#SYMVER sk_free 0xf33af8b9
#SYMVER sk_clone_lock 0x998c644d
#SYMVER sk_free_unlock_clone 0x9e4d5a0a
#SYMVER sk_setup_caps 0xa99b87a1
#SYMVER sock_wfree 0xe74443c6
#SYMVER skb_set_owner_w 0x0a5a853f
#SYMVER skb_orphan_partial 0xf4138ceb
#SYMVER sock_rfree 0x468e41a4
#SYMVER sock_efree 0x7a5c410e
#SYMVER sock_pfree 0x6bef4125
#SYMVER sock_i_uid 0x37548669
#SYMVER __sock_i_ino 0xf04b522a
#SYMVER sock_i_ino 0x9846b85d
#SYMVER sock_wmalloc 0x7b62de73
#SYMVER sock_kmalloc 0x79177080
#SYMVER sock_kfree_s 0x2932c1c6
#SYMVER sock_kzfree_s 0x7b1bcd34
#SYMVER sock_alloc_send_pskb 0x96b1293c
#SYMVER __sock_cmsg_send 0x369e4faf
#SYMVER sock_cmsg_send 0x1eee715d
#SYMVER skb_page_frag_refill 0xd771d6ce
#SYMVER sk_page_frag_refill 0x04fe914b
#SYMVER __sk_flush_backlog 0x9ed2b1da
#SYMVER sk_wait_data 0x171b4e4f
#SYMVER __sk_mem_schedule 0x5d0847dd
#SYMVER __sk_mem_reclaim 0x058fc27d
#SYMVER sk_set_peek_off 0x46336057
#SYMVER sock_no_bind 0x9252cbd2
#SYMVER sock_no_connect 0x15fcbdad
#SYMVER sock_no_socketpair 0x28e2e058
#SYMVER sock_no_accept 0x92724e6a
#SYMVER sock_no_getname 0x85988b5f
#SYMVER sock_no_ioctl 0x57090976
#SYMVER sock_no_listen 0x691c6355
#SYMVER sock_no_shutdown 0x625c6bab
#SYMVER sock_no_sendmsg 0x52faf957
#SYMVER sock_no_sendmsg_locked 0x0957a138
#SYMVER sock_no_recvmsg 0xfbb08405
#SYMVER sock_no_mmap 0xebf80697
#SYMVER sk_send_sigurg 0x9e805ff1
#SYMVER sk_reset_timer 0x75c756de
#SYMVER sk_stop_timer 0x39542f42
#SYMVER sk_stop_timer_sync 0x578334a2
#SYMVER sock_init_data_uid 0x9d4f95a6
#SYMVER sock_init_data 0x0a813464
#SYMVER lock_sock_nested 0x2702827f
#SYMVER release_sock 0xd2d80c01
#SYMVER __lock_sock_fast 0x05b2d4a8
#SYMVER sock_gettstamp 0x83227012
#SYMVER sock_recv_errqueue 0x3524e91f
#SYMVER sock_common_getsockopt 0x1f1beab6
#SYMVER sock_common_recvmsg 0x3ee14d42
#SYMVER sock_common_setsockopt 0x5c2fb513
#SYMVER sk_common_release 0x560c3ffb
#SYMVER sock_prot_inuse_get 0xaeac7617
#SYMVER sock_inuse_get 0x64a43725
#SYMVER proto_register 0xa8707ce6
#SYMVER proto_unregister 0x026fb156
#SYMVER sock_load_diag_module 0xf665f74f
#SYMVER sk_busy_loop_end 0xe590dea3
#SYMVER sock_bind_add 0x0caa0145
#SYMVER sock_ioctl_inout 0x54c438ae
#SYMVER sk_ioctl 0x8f76a0d4
