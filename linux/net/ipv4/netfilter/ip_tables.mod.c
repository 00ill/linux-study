...
SYMBOL_CRC(ipt_alloc_initial_table, 0x5b3f0312, "_gpl");
SYMBOL_CRC(ipt_register_table, 0x2c5e77bd, "");
SYMBOL_CRC(ipt_unregister_table_pre_exit, 0x549dff67, "");
SYMBOL_CRC(ipt_unregister_table_exit, 0x4348fdfc, "");
SYMBOL_CRC(ipt_do_table, 0x825e6448, "");
...
MODULE_INFO(srcversion, "80D04EB8A9B6BE6649C7F2C");
