...
__used __section("__versions") = {
	...
	{ 0x43769d9c, "eth_commit_mac_addr_change" },
...
MODULE_ALIAS("usb:v2C7Cp0122d*dc*dsc*dp*icFFiscFFipFFin*");
...
MODULE_ALIAS("usb:v19D2p0189d*dc*dsc*dp*ic*isc*ip*in04*");
...
MODULE_ALIAS("usb:v1BC7p1034d*dc*dsc*dp*ic*isc*ip*in02*");
MODULE_ALIAS("usb:v1BC7p1037d*dc*dsc*dp*ic*isc*ip*in04*");
MODULE_ALIAS("usb:v1BC7p1038d*dc*dsc*dp*ic*isc*ip*in03*");
...
MODULE_ALIAS("usb:v1BC7p1077d*dc*dsc*dp*ic*isc*ip*in02*");
MODULE_ALIAS("usb:v1BC7p1080d*dc*dsc*dp*ic*isc*ip*in02*");
MODULE_ALIAS("usb:v1BC7p10A0d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10A4d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10A9d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10B0d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10C0d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10C4d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10C8d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p10D0d*dc*dsc*dp*ic*isc*ip*in00*");
...
MODULE_ALIAS("usb:v1BC7p3000d*dc*dsc*dp*ic*isc*ip*in00*");
MODULE_ALIAS("usb:v1BC7p3001d*dc*dsc*dp*ic*isc*ip*in00*");
...
MODULE_ALIAS("usb:v1C9Ep9B05d*dc*dsc*dp*ic*isc*ip*in04*");
MODULE_ALIAS("usb:v1C9Ep9B3Cd*dc*dsc*dp*ic*isc*ip*in04*");
...
MODULE_ALIAS("usb:v1E0Ep9071d*dc*dsc*dp*ic*isc*ip*in03*");
...
MODULE_ALIAS("usb:v2CB7p0112d*dc*dsc*dp*ic*isc*ip*in00*");
...
MODULE_ALIAS("usb:v1546p1312d*dc*dsc*dp*ic*isc*ip*in04*");
MODULE_ALIAS("usb:v1546p1342d*dc*dsc*dp*ic*isc*ip*in04*");
MODULE_ALIAS("usb:v33F8p0104d*dc*dsc*dp*ic*isc*ip*in04*");
...
MODULE_INFO(srcversion, "258C9EB70B52954484FAC99");
