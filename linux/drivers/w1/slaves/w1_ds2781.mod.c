...
KSYMTAB_FUNC(w1_ds2781_io, "", "");
KSYMTAB_FUNC(w1_ds2781_eeprom_cmd, "", "");

SYMBOL_CRC(w1_ds2781_io, 0x5c2df247, "");
SYMBOL_CRC(w1_ds2781_eeprom_cmd, 0xa1795977, "");
...
MODULE_INFO(srcversion, "6BF3BE0D71F5EE30402E590");
