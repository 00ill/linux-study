...
KSYMTAB_DATA(tpg_pattern_strings, "_gpl", "");
KSYMTAB_DATA(tpg_aspect_strings, "_gpl", "");
KSYMTAB_FUNC(tpg_set_font, "_gpl", "");
KSYMTAB_FUNC(tpg_init, "_gpl", "");
KSYMTAB_FUNC(tpg_alloc, "_gpl", "");
KSYMTAB_FUNC(tpg_free, "_gpl", "");
KSYMTAB_FUNC(tpg_s_fourcc, "_gpl", "");
KSYMTAB_FUNC(tpg_s_crop_compose, "_gpl", "");
KSYMTAB_FUNC(tpg_reset_source, "_gpl", "");
KSYMTAB_FUNC(tpg_g_interleaved_plane, "_gpl", "");
KSYMTAB_FUNC(tpg_gen_text, "_gpl", "");
KSYMTAB_FUNC(tpg_g_color_order, "_gpl", "");
KSYMTAB_FUNC(tpg_update_mv_step, "_gpl", "");
KSYMTAB_FUNC(tpg_calc_text_basep, "_gpl", "");
KSYMTAB_FUNC(tpg_log_status, "_gpl", "");
KSYMTAB_FUNC(tpg_fill_plane_buffer, "_gpl", "");
KSYMTAB_FUNC(tpg_fillbuffer, "_gpl", "");
...
MODULE_INFO(srcversion, "E9AA86B041C6A22958286C4");
