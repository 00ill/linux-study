...
__used __section("__versions") = {
	...
	{ 0xf796b4c5, "drm_of_get_data_lanes_count_ep" },
...
MODULE_ALIAS("of:N*T*Cpanel-dsi");
MODULE_ALIAS("of:N*T*Cpanel-dsiC*");
...
MODULE_ALIAS("of:N*T*Cauo,g104stn01");
MODULE_ALIAS("of:N*T*Cauo,g104stn01C*");
...
MODULE_ALIAS("of:N*T*Cauo,g156han04");
MODULE_ALIAS("of:N*T*Cauo,g156han04C*");
...
MODULE_ALIAS("of:N*T*Cboe,bp082wx1-100");
MODULE_ALIAS("of:N*T*Cboe,bp082wx1-100C*");
MODULE_ALIAS("of:N*T*Cboe,bp101wx1-100");
MODULE_ALIAS("of:N*T*Cboe,bp101wx1-100C*");
...
MODULE_ALIAS("of:N*T*Ccct,cmt430b19n00");
MODULE_ALIAS("of:N*T*Ccct,cmt430b19n00C*");
...
MODULE_ALIAS("of:N*T*Cedt,etml1010g3dra");
MODULE_ALIAS("of:N*T*Cedt,etml1010g3draC*");
...
MODULE_ALIAS("of:N*T*Cevervision,vgg644804");
MODULE_ALIAS("of:N*T*Cevervision,vgg644804C*");
...
MODULE_ALIAS("of:N*T*Cinnolux,g070ace-lh3");
MODULE_ALIAS("of:N*T*Cinnolux,g070ace-lh3C*");
...
MODULE_ALIAS("of:N*T*Cinnolux,g121xce-l01");
MODULE_ALIAS("of:N*T*Cinnolux,g121xce-l01C*");
...
MODULE_ALIAS("of:N*T*Contat,kd50g21-40nt-a1");
MODULE_ALIAS("of:N*T*Contat,kd50g21-40nt-a1C*");
...
MODULE_ALIAS("of:N*T*Cpowertip,ph128800t006-zhc01");
MODULE_ALIAS("of:N*T*Cpowertip,ph128800t006-zhc01C*");
MODULE_ALIAS("of:N*T*Cpowertip,ph800480t013-idf02");
MODULE_ALIAS("of:N*T*Cpowertip,ph800480t013-idf02C*");
MODULE_ALIAS("of:N*T*Cprimeview,pm070wl4");
MODULE_ALIAS("of:N*T*Cprimeview,pm070wl4C*");
...
MODULE_ALIAS("of:N*T*Cmicrochip,ac69t88a");
MODULE_ALIAS("of:N*T*Cmicrochip,ac69t88aC*");
MODULE_ALIAS("of:N*T*Cpanel-dpi");
MODULE_ALIAS("of:N*T*Cpanel-dpiC*");

MODULE_INFO(srcversion, "520009E470967296E1ECCBF");
