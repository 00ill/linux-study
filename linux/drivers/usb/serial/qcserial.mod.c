...
__used __section("__versions") = {
	...
	{ 0x84eb2f66, "usb_wwan_suspend" },
	{ 0x5af97615, "usb_wwan_resume" },
	{ 0x5df269d7, "usb_wwan_open" },
	{ 0x9742e7d6, "usb_wwan_close" },
	{ 0x4ed6f6e1, "usb_wwan_write" },
	{ 0x3cb577cb, "usb_wwan_write_room" },
	{ 0xf1c92ae4, "usb_wwan_chars_in_buffer" },
	{ 0x2eb0f108, "usb_wwan_tiocmget" },
	{ 0xa1988144, "usb_wwan_tiocmset" },
	{ 0xf546739b, "usb_wwan_dtr_rts" },
...
MODULE_ALIAS("usb:v1199p90E4d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v1199p90E5d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_ALIAS("usb:v413Cp8217d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v413Cp8218d*dc*dsc*dp*ic*isc*ip*in*");
MODULE_ALIAS("usb:v03F0p581Dd*dc*dsc*dp*ic*isc*ip*in*");

MODULE_INFO(srcversion, "D73B1FA389A9347EF43BCA3");
