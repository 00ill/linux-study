...
$(deps_fs/locks.o):
#SYMVER locks_alloc_lock 0x5afdf0b8
#SYMVER locks_alloc_lease 0x3af71582
#SYMVER locks_release_private 0xb3453363
#SYMVER locks_owner_has_blockers 0x45a25ee5
#SYMVER locks_free_lock 0x18dbae46
#SYMVER locks_free_lease 0xb527c3cc
#SYMVER locks_init_lock 0xd0dfe9e4
#SYMVER locks_init_lease 0xc1ae0190
#SYMVER locks_copy_conflock 0x958155d9
#SYMVER locks_copy_lock 0x4870a479
#SYMVER locks_delete_block 0x6fd99dc8
#SYMVER posix_test_lock 0xfbc81c26
#SYMVER posix_lock_file 0x4a3cdc00
#SYMVER lease_modify 0xa9b48076
#SYMVER __break_lease 0x40311d17
#SYMVER lease_get_mtime 0xeeeaf319
#SYMVER generic_setlease 0xc26dfe4b
#SYMVER lease_register_notifier 0x43aa319e
#SYMVER lease_unregister_notifier 0x985453e1
#SYMVER kernel_setlease 0x15291209
#SYMVER vfs_setlease 0x4fcdee9e
#SYMVER locks_lock_inode_wait 0x5964f3fc
#SYMVER vfs_test_lock 0x49495e10
#SYMVER vfs_lock_file 0xc5070f87
#SYMVER locks_remove_posix 0x7033b702
#SYMVER vfs_cancel_lock 0x26c85616
#SYMVER vfs_inode_has_locks 0xb188fe1f
