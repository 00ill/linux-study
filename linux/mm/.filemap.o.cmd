...
$(deps_mm/filemap.o):
#SYMVER filemap_check_errors 0x34eddbf8
#SYMVER filemap_fdatawrite_wbc 0x2d50b453
#SYMVER filemap_fdatawrite 0x9ccee4df
#SYMVER filemap_fdatawrite_range 0x704c6109
#SYMVER filemap_flush 0x47a9fa49
#SYMVER filemap_range_has_page 0xc9381a02
#SYMVER filemap_fdatawait_range 0xc122bb20
#SYMVER filemap_fdatawait_range_keep_errors 0x74bcd7e2
#SYMVER file_fdatawait_range 0xfbef5847
#SYMVER filemap_fdatawait_keep_errors 0xc43215a2
#SYMVER filemap_range_has_writeback 0xe4242a0c
#SYMVER filemap_write_and_wait_range 0x323ba371
#SYMVER __filemap_set_wb_err 0x931ffb97
#SYMVER file_check_and_advance_wb_err 0x49fe236e
#SYMVER file_write_and_wait_range 0xecffe2e8
#SYMVER replace_page_cache_folio 0x176cf711
#SYMVER filemap_add_folio 0x3b662653
#SYMVER filemap_alloc_folio_noprof 0x8dec4889
#SYMVER filemap_invalidate_lock_two 0x90c7d01a
#SYMVER filemap_invalidate_unlock_two 0x4e96fb76
#SYMVER folio_wait_bit 0x2ffe5753
#SYMVER folio_wait_bit_killable 0xab6c600d
#SYMVER folio_add_wait_queue 0x6df67bf4
#SYMVER folio_unlock 0xa0006fa1
#SYMVER folio_end_read 0xa5972220
#SYMVER folio_end_private_2 0x31771b37
#SYMVER folio_wait_private_2 0xa7b65a58
#SYMVER folio_wait_private_2_killable 0xa2e9e722
#SYMVER folio_end_writeback 0x31bf97ef
#SYMVER __folio_lock 0xf563f1e6
#SYMVER __folio_lock_killable 0x676bd84e
#SYMVER page_cache_next_miss 0x25142b54
#SYMVER page_cache_prev_miss 0xd93a6acf
#SYMVER __filemap_get_folio 0xed09f283
#SYMVER filemap_get_folios 0x830b58ee
#SYMVER filemap_get_folios_contig 0x72171104
#SYMVER filemap_get_folios_tag 0x1b101f16
#SYMVER filemap_read 0xfe5b2a1c
#SYMVER kiocb_write_and_wait 0x92c7436e
#SYMVER kiocb_invalidate_pages 0xb9a6520b
#SYMVER generic_file_read_iter 0x9af62503
#SYMVER filemap_splice_read 0xfa34da95
#SYMVER filemap_fault 0x2938b87e
#SYMVER filemap_map_pages 0xbdf17de2
#SYMVER filemap_page_mkwrite 0x28dd719f
#SYMVER generic_file_mmap 0xde4c861a
#SYMVER generic_file_readonly_mmap 0x0b68879d
#SYMVER read_cache_folio 0x9763e5bf
#SYMVER mapping_read_folio_gfp 0xc0b3719c
#SYMVER read_cache_page 0xc02433fb
#SYMVER read_cache_page_gfp 0xf23a5c75
#SYMVER generic_file_direct_write 0x330bcb26
#SYMVER generic_perform_write 0x044590f2
#SYMVER __generic_file_write_iter 0xb3434d03
#SYMVER generic_file_write_iter 0x4ece803d
#SYMVER filemap_release_folio 0x635028ce
#SYMVER filemap_invalidate_inode 0xa1696677
